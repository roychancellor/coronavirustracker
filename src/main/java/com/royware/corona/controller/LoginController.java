...
import com.royware.corona.model.Checking;
...
import com.royware.corona.viewforms.LoginForm;
import com.royware.corona.viewforms.PasswordForm;
import com.royware.corona.services.*;
...
public class LoginController {
	...
	public String showStatementsScreen(@ModelAttribute("customer") Customer customer, ModelMap map) {
		...
		if(customer.getCustId() != 0) {
			...
			List<Transaction> transList = dataService.dbRetrieveTransactionsById(customer.getCustId());
			dataService.close();
