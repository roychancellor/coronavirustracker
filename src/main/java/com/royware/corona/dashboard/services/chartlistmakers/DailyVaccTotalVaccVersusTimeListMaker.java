...
@Component
public class DailyVaccTotalVaccVersusTimeListMaker implements ChartListMaker {
	private static final Logger log = LoggerFactory.getLogger(DailyVaccTotalVaccVersusTimeListMaker.class);
