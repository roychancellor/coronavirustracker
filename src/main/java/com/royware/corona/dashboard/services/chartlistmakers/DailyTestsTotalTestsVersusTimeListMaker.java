...
@Component
public class DailyTestsTotalTestsVersusTimeListMaker implements ChartListMaker {
	private static final Logger log = LoggerFactory.getLogger(DailyTestsTotalTestsVersusTimeListMaker.class);
