...
@Component
public class CurrentTotalDeathsWithPercentOfPopulationListMaker implements ChartListMaker {
	private static final Logger log = LoggerFactory.getLogger(CurrentTotalDeathsWithPercentOfPopulationListMaker.class);
