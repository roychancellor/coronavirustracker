...
@Component
public class DailyAccelerationOfCasesWithMovingAverageListMaker implements ChartListMaker {
	private static final Logger log = LoggerFactory.getLogger(DailyAccelerationOfCasesWithMovingAverageListMaker.class);
