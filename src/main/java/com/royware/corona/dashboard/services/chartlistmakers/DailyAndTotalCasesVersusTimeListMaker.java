...
@Component
public class DailyAndTotalCasesVersusTimeListMaker implements ChartListMaker {
	private static final Logger log = LoggerFactory.getLogger(DailyAndTotalCasesVersusTimeListMaker.class);
