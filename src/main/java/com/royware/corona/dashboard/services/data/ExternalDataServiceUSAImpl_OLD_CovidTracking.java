...
@Component("us")
public class ExternalDataServiceUSAImpl_OLD_CovidTracking implements ExternalDataService {
	@Autowired
	private RestTemplate restTemplate;
	
	private static final Logger log = LoggerFactory.getLogger(ExternalDataServiceUSAImpl_OLD_CovidTracking.class);
