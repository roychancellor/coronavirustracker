...
@Component
public class TotalDeathsVersusTimeWithExponentialFitListMaker implements ChartListMaker {
	private static final Logger log = LoggerFactory.getLogger(TotalDeathsVersusTimeWithExponentialFitListMaker.class);
