...
public interface ChartService {
	public <T extends CanonicalCaseDeathData> List<List<Map<Object, Object>>> getTotalCasesVersusTimeWithExponentialFit(List<T> regionDataList);
	public <T extends CanonicalCaseDeathData> List<List<Map<Object, Object>>> getDailyRateOfChangeOfCasesWithMovingAverage(List<T> regionDataList);
	public <T extends CanonicalCaseDeathData> List<List<Map<Object, Object>>> getDailyAccelerationOfCasesWithMovingAverage(List<T> regionDataList);
	public <T extends CanonicalCaseDeathData> List<List<Map<Object, Object>>> getChangeInTotalCasesVersusCaseswithExponentialLine(List<T> regionDataList);
	public <T extends CanonicalCaseDeathData> List<List<Map<Object, Object>>> getTotalDeathsVersusTimeWithExponentialFit(List<T> regionDataList);
	...
	public <T extends CanonicalCaseDeathData> List<List<Map<Object, Object>>> getDailyHospitalizedTotalWithMovingAverage(List<T> regionDataList);
	...
	public <T extends CanonicalCaseDeathData> List<List<Map<Object, Object>>> getCurrentTotalDeathsWithPercentOfPopulation(List<T> regionDataList,
			Integer regionPopulation);
}
